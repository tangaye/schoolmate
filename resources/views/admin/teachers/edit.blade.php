...
<ul class="sidebar-menu">
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      ...
      <li><a href="{{route('teachers.form')}}"><i class="glyphicon glyphicon-pencil"></i>New Guardian</a></li>
    </ul>
  </li>
            ...
            <ul class="nav nav-stacked">
              ...
              <li>
                  <a href="javascript:void(0)">Address 
                      <span class="pull-right badge label-default">
                          {{$teacher->address}}
                      </span>
                  </a>
              </li>
      ...
      @include ('layouts.errors')
        ...
        <form method="POST" action="/admin/teachers/update/{{$teacher->id}}">
          ...
          <div class="panel-footer text-right">
            ...
            <a href="{{route('teachers.home')}}" class="btn btn-default">Cancel</a>
          </div>
        </form>
			</div>
			<!-- /. close of panel div -->
