...
@section('page-title', 'Update Sponsor')
...
<ul class="sidebar-menu">
  ...
  <li class="treeview active">
    ...
    <ul class="treeview-menu">
      ...
      <li class="active"><a href="{{route('admin.ponsor.home')}}"><i class="glyphicon glyphicon-knight"></i>Sponsors</a></li>
    </ul>
  </li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default ol-md-offset-2">
                <div class="panel-heading">
                    <span class="panel-title">Update Sponsor Grade (<b>{{$academic->full_year}}</b>)</span>
                </div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="/admin/sponsor/update/{{$sponsor->id}}">
                    ...
                    <input type="" name="teacher_id" value="{{$sponsor->teacher_id}}" class="hidden">

                    <input type="" name="academic_id" value="{{$sponsor->academic_id}}" class="hidden">

                    <div class="form-group{{ $errors->has('teacher_id') ? ' has-error' : '' }}">
                        <label class="col-md-2 control-label">Teacher</label>

                        <div class="col-md-8">
                          <input readonly="" class="form-control" type="" value="{{$sponsor->first_name." ".$sponsor->surname}}">
                    ...
                    <div class="form-group{{ $errors->has('grade_id') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                          <select name="grade_id" id="last_grade" class="form-control" required="">
                            @foreach($grades as $grade)
                              <option value="{{$grade->id}}" {{$grade->id === $sponsor->grade_id ? 'selected' : ''}}>{{$grade->name}}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="form-group">
                      <div class="col-md-4 col-md-offset-2">
                          ...
                          <a class="btn btn-default" href="{{route('admin.ponsor.home')}}">Cancel</a>
                      </div>
                    </div>
                  </form>
                </div>
