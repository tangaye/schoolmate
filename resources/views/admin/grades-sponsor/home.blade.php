...
@section('content')
  <!-- grades sponsor create modal form start -->
  @include('admin.grades-sponsor.create')
  <!-- grades sponsor create modal form end -->
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="container-fluid">
						<span class="panel-title">Grades sponsored by teachers</span>
...
@section('page-scripts')
  ...
  <script src="{{ asset ("/bower_components/AdminLTE/plugins/select2/select2.full.min.js") }}"></script>
	<script type="text/javascript" src="{{asset("/js/grades-sponsor/admin/home.js")}}"></script>
  @if($flash = session('message'))
    <script type="text/javascript">
        var message = "Teacher: <b>{{$flash}}</b> sponsor grade updated!";
        notify(message);
    </script>
  @endif
@endsection