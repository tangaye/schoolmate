...
@section('page-header', 'Student Transcript')
      ...
      <div class="panel">
        <div class="panel-body">
          <div class="form-group">
            ...
            <select name="student_id" class="form-control student" style="width: 100%;">
              <option value="" selected="">Select Student</option>
              @foreach($students as $student)
                <option value="{{$student->id}}">{{"(".$student->student_code.") ".$student->first_name." ".$student->middle_name." ".$student->surname}}</option>
              @endforeach
            </select>
          </div>
          <div id="message"></div>
...
@section('page-scripts')
	...
	<script type="text/javascript" src="{{asset("/js/transcripts/admin/home.js")}}"></script>
