...
@section('content')
	...
	<div class="row">
        ...
        <form class="form-horizontal" method="POST" action="/roles/update/{{$role->id}}">
                        ...
                        <tr>
                          <div class="col-md-4">
                            <label class="checkbox-inline">
                              <input type="checkbox" name="permissions[{{$key}}]" value="{{$value}}" {{ isset($role->permissions[$key]) ? 'checked=""' : ''}}">{{$key}}
                            </label>
                          </div>
                        </tr>
                      @endforeach
            ...
            <div class="panel-footer text-right">
              ...
              <a href="{{route('roles.home')}}" class="btn btn-default">Cancel</a>
            </div>
          </form>
			</div>
		</div>	
