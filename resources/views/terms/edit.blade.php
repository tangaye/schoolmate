                ...
                <form action="" method="PUT" id='edit-form'>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted">Select semester term in found in.</p>
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                        	<button name="edit-btn" id="update-term" class="btn btn-success form-control"> <i class="glyphicon glyphicon-edit"></i> Update</button>
                        </div>
                    </div>
