<form class="form-horizontal" action="" method="post" id='add-form'>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input class="form-control" name="name" id="name" type="text" placeholder="Semester Name" required="true">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <button name="add-btn" id="insert-semester" type="submit" class="btn btn-info btn-flat btn-submit" >Save Semester</button>
        </div>
    </div>
