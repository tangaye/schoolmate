  ...
  <ul class="sidebar-menu">
    ...
    <li class="active treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{route('teacher.annual-scores')}}"><i class="fa fa-file-text-o"></i>Annual Report</a></li>
      </ul>
    </li>
  </ul>
  <!-- /.sidebar-menu -->
...
@section('page-scripts')
  ...
  <script type="text/javascript" src="{{asset("/js/scores/teacher/student-annual-scores.js")}}"></script>
@endsection