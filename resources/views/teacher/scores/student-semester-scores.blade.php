  ...
  <ul class="sidebar-menu">
    ...
    <li class="active treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{route('teacher.semester-scores')}}"><i class="fa fa-file-text-o"></i>Semester Report</a></li>
        ...
        @endcomponent
          ...
          <div class="row">
            ...
            <div class="form-group col-md-3">
              ...
              <select name="semester_id"  disabled=""  class="form-control search_fields" id="semester">
...
@section('page-scripts')
  ...
  <script type="text/javascript" src="{{asset("/js/scores/teacher/student-semester-scores.js")}}"></script>
@endsection